...
* Using non-standard file suffixes (e.g. <tt>mime-types</tt> has a <tt>.rb.data</tt> file)
  * This will be addressed in a later release (possibly)
* Gems that explicitly require a file with the file suffix (e.g. <tt>require 'nokogiri.rb'</tt>)
  * This should be addressable in a future release (possibly)
...
The functionality provided by this gem can be enabled by default in MacRuby by applying a patch found in my MacRuby fork at https://github.com/ferrous26/MacRuby/tree/rubygems-rbo.
